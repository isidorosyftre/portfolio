          ...
          <div className="flex items-center space-x-2">
            {isEditMode ? (
              <>
                <button
                  onClick={handleSave}
                  className="flex items-center space-x-1 px-4 py-2 bg-green-500 text-white hover:bg-green-600 transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-4 py-2 bg-gray-500 text-white hover:bg-gray-600 transition-colors"
                >
                  <X className="w-4 h-4" />
                  <span>Cancel</span>
                </button>
              ...
              <button
                ...
                className="flex items-center space-x-1 px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 transition-colors"
              >
